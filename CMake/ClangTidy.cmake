...
function (createClangTidyTargets targetName subdirectory checkonly)
    ...
    file(
        GLOB_RECURSE FILES_TO_TIDY
        RELATIVE ${CMAKE_CURRENT_SOURCE_DIR}
        ${subdirectory}/*.cpp ${subdirectory}/*.hpp ${subdirectory}/*.h
    )

    if (${checkonly})
        set(TIDY_EXPORT_PARAMS --export-fixes=results.json)
        ...
        add_custom_target(
            ${targetName}
            COMMAND ${CLANG_TIDY} ${TIDY_EXPORT_PARAMS} ${FILES_TO_TIDY}
            WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
        )

    else () # Not used yet
        set(TIDY_FIX_PARAMS --export-fixes=fixes.yaml --fix)
        ...
        add_custom_target(
            ${targetName}
            COMMAND ${CLANG_TIDY} ${TIDY_FIX_PARAMS} ${FILES_TO_TIDY}
            WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
        )
    endif ()
endfunction ()
