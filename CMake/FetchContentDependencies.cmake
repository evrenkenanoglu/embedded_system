...
# ##################################################################################################
# Set the runtime library to use These lines tell Google Test to use the dynamic release version of
# the runtime library (/MD) and to match your project's runtime library settings.
set(gtest_force_shared_crt
    ON
    CACHE BOOL "" FORCE
)
set(gtest_MSVC_RUNTIME_LIBRARY
    "MultiThreaded$<$<CONFIG:Debug>:Debug>DLL"
    CACHE STRING "MD" FORCE
)
