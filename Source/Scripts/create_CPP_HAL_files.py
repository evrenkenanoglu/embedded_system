...
if hal_type != "":
    hal_type.lower()
    if hal_type == "IO" or hal_type == "COM" or hal_type == "MEM" or hal_type == "CPX":
        filename = hal_type.lower() + "_" + filename.lower()
    else:
...
header_content = header_template.format(
    ...
    brief=brief,
    abstract_header_file=(
        ihal_header_file if ihal_header_file != "" else iprocess_header_file
    ),
