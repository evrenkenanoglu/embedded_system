        ...
        <form method=\"POST\">\
          <div class=\"form__group\">\
            ...
            <datalist id=\"ssidList\">\
              <!-- Options will be populated by the scan function -->\
            </datalist>\
          </div>\
          <div class=\"form__group\">\
          ...
          <div class=\"form__buttons\">\
            <button type=\"submit\" class=\"form__button\" id=\"connectButton\">\
              CONNECT</button>\
            <button type=\"button\" class=\"form__button\" id=\"scanButton\"\
...
\
  ...
  document.getElementById('scanButton').style.backgroundColor = 'gray';\
\
  disableButtons();\
...
function enableButtons() {\
  ...
  document.getElementById('connectButton').style.backgroundColor = '#0077b6';\
  document.getElementById('scanButton').style.backgroundColor = '#0077b6';\
}\
    </script>\
  </body>\
</html>\
