...
namespace BUTTON
{
    ...
    static constexpr Config_t DEFAULT_CONFIG(
        uint16_t longPressThresholdMs = LONG_PRESS_THRESHOLD_MS, uint16_t shortPressThresholdMs = SHORT_PRESS_THRESHOLD_MS,
        uint16_t doubleClickWindowMs = DOUBLE_CLICK_WINDOW_MS, hal_gpio_level_t pressedState = hal_gpio_level_t::LOW)
    {
        return Config_t{
